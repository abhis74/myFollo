...
function JoinMApp(){
    ...
    return(
        ...
        <div className="pagebannerSection">
          <div className="pagebannerheadingBox">
            <p className="subtext"> <span><img src={bulding} alt="bulding" /></span>{JoinMAppData.banner.subtext}</p>
            <h1>{JoinMAppData.banner.title}</h1>
            <p className="pagebannersubtitle"> {JoinMAppData.banner.subtitle}</p>
            {/* <Link to="/register">
      ...
      <div className="pageHeroSection">
              <div className="headingsection">
                <h2>
                  {JoinMAppData.heroSection.heading}
                </h2><span>{JoinMAppData.heroSection.headingpart}</span>
                ...
                <ul>
                  {JoinMAppData.heroSection.highlightpoints.map((item,index)=>{
                    return(
                      ...
                      <li className="highlightpointsItem" key={index}><span><img src={check} alt="check" /></span>{item}</li>
                    )
      ...
      <Feature feature={transact.feature} heading="Let us show‍ you how we make it happen." subtextone="Our Process" subtextTwo="A Proven Framework to Build & Preserve Legacy" btnText="Refer a Client"/>
 ...
 <Form Heading="Let’s create value together." subtext="Whether you want to refer a client or join the program, we’re happy to connect." className="JoinMAppData"/>
